                        ...
                        <div class="col-md-3">
                            <div class="form-group"><label for="" class="text-bold">Milik Perusahaan</label>
                                <select class="form-control" name="company_id" id="company_id">
                                    ...
                                    <option value="{{ $company->company_id }}" @if ($transaction?->
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group"><label for="" class="text-bold">Nama Pelanggan</label>
                                <select class="form-control" name="customer_id" id="customer_id" required>
                                    ...
                                    <option value="{{ $customer->customer_id }}" @if ($transaction?->
                                        customer_id==$customer->customer_id) selected @endif>{{ $customer->customer_name
                                        }}
                                    </option>
                                    @endforeach
                                    @endif
                                        ...
                                        <tr>
                                            <td colspan="5">
                                                <button type="button" id="add_row"
                                                    @if($transaction?->TransactionDetails)
                                                    onclick="transactionAddRowUpdate(this)"
                                                    @else
                                                    onclick="transactionAddRow(this)"
                                                    @endif
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group"><label for="" class="text-bold">Diskon (%)</label>
                                        ...
                                        if(document.getElementById('transaction_discount2')){document.getElementById('transaction_discount2').value=`${(this.value/100) * document.getElementById('transaction_total').value}`;calculateGrandTotal()};if(document.getElementById('transaction_discount2_update')){document.getElementById('transaction_discount2_update').value=`${(this.value/100) * document.getElementById('transaction_total_update').value}`;calculateGrandTotalUpdate()}
                                            ...
                                            value="{{ $transaction?->transaction_discount ? round(($transaction?->transaction_discount/$transaction?->transaction_total)*100,2) : 0 }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group"><label for="" class="text-bold">Status
                                        ...
                                        <select class="form-control" name="payment_status" id="payment_status">
                                            ...
                                            <option value="{{ $status[0] }}" @if ($transaction?->payment_status ==
                                ...
                                <div class="col-md-3">
                                    <div class="form-group"><label for="" class="text-bold">Status
                                        ...
                                        <select class="form-control" name="transaction_status" id="transaction_status">
                                            ...
                                            <option value="{{ $status[0] }}" @if ($transaction?->transaction_status ==
                                                $status[0]) selected @endif>
                                                {{ $status[1] }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group"><label for="" class="text-bold">Dengan Pajak</label>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" onchange="calculateGrandTotalUpdate()"
                                                type="checkbox" name="transaction_tax" id="transaction_tax_check_update"
                                                value="true" @if ($transaction?->transaction_tax> 0)
                                            checked
                                            @endif>
                                    ...
                                    <div class="form-group"><label for="" class="text-bold">Export Audit</label>
                                        <div class="form-check">
                                            <input class="form-check-input" onchange="" type="checkbox"
                                                ...
                                                @if($transaction?->transaction_audit == 'true')
                                            checked
                                            @endif>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group"><label for="" class="text-bold">Catatan
                                            Pesanan</label>
                                        <textarea class="form-control" name="transaction_notes" id="transaction_notes"
                                            cols="30" rows="2">{{ $transaction?->transaction_notes }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="float-end">
                                    <input class="form-control-plaintext form-control-sm text-end" readonly
                                        ...
                                        value="{{ intval($transaction?->transaction_total) }}" autocomplete="off">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span>Diskon :</span>
                                <div class="float-end">
                                    <input class="form-control-plaintext form-control-sm text-danger text-end" readonly
                                        type="number" name="" id="transaction_discount2_update" value="{{
                                            intval($transaction?->transaction_discount) ??
                                            0}}">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="float-end">
                                    <input class="form-control-plaintext form-control-sm text-end" readonly
                                        type="number" name="" id="transaction_tax_update" value="{{
                                            intval($transaction?->transaction_tax) ??
                                            0}}">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="float-end">
                                    <input class="form-control-plaintext form-control-sm text-end" readonly
                                        type="number" name="" id="transaction_grand_total_update" value="{{
                                            intval($transaction?->transaction_grand_total) ??
                                            0}}">
                                </div>
                            </div>
                            @else
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="float-end">
                                    <input class="form-control-plaintext form-control-sm text-end" readonly
                                        type="number" name="" id="transaction_total" value="{{
                                            intval($transaction?->transaction_total) ??
                                            0}}" autocomplete="off">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="float-end">
                                    <input class="form-control-plaintext form-control-sm text-danger text-end" readonly
                                        type="number" name="" id="transaction_discount2" value="{{
                                            intval($transaction?->transaction_discount) ??
                                            0}}">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="float-end">
                                    <input class="form-control-plaintext form-control-sm text-end" readonly
                                        type="number" name="" id="transaction_tax" value="{{
                                            intval($transaction?->transaction_tax) ??
                                            0}}">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="float-end">
                                    <input class="form-control-plaintext form-control-sm text-end" readonly
                                        type="number" name="" id="transaction_grand_total" value="{{
                                            intval($transaction?->transaction_grand_total) ??
                                            0}}">
                                </div>
                            </div>
...
<script defer>
    ...
    function calculateGrandTotalUpdate(){
        ...
        grand_total = total - discount
        console.log({transaction_tax_check_update,transaction_total_label_update,transaction_discount_label_update,transaction_tax_label_update,transaction_grand_total_label_update})
    ...
    function calculate() {
        let index = $('#dynamic-transaction-product tr').length
        let count = 0
        let product_quantity =0 , product_price =0 , product_subtotal =0 ,transaction_total =0 ,transaction_grand_total = 0
        ...
        while (count != index) {
            ...
            product_price = document.querySelector(`[id="product_quantity"][index="${count}"]`) && document.querySelector(`[id="product_price"][index="${count}"]`).value;
    ...
    function calculateUpdate() {
        ...
        while (count != index) {
            ...
            product_price = document.querySelector(`[id="product_quantity_update"][index="${count}"]`) && parseInt(document.querySelector(`[id="product_price_update"][index="${count}"]`).value);
            product_subtotal = product_quantity * product_price
